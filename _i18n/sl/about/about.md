...
this.vizitka = () => {
  ...
  'flattr': 'mitjajez',
  'opis': 'Sam sebe imenujem kar socialni inženir, ker me zanima psihologija \
    in skrb za družbo, da lahko vidim širšo sliko ekonomskih problemov. \
    Slednje rešujem skozi odprtokodnine inženirske aplikacije in deljenjem.',
}
```

# Nekaj priljubljenih komentarjev:
...
# Izobrazba:
* 2016 (še zagovor): univerzitetni diplomiran inženir elektrotehnike, smer elektronika
* 2004: elektrotehnik elektronik
* 2002: elektrikar elektronik

# Projekti:
* 2016 – danes: SONCE – Simple ONline Circuit Editor
  [(koda)](https://github.com/mitjajez/SONCE/) (ver. 0.3+: Meteor)
...
* Strežniki in podatkovna baze: Linux, Apache, MySQL, PHP, Node.js, MongoDB,
  Docker;
* Orodja za skripte in manipulacijo podatkov: shell utilities, vim, regular
  expressions;
* Grafične tehnologije: SVG;
* Grafična orodja: Inkscape, Gimp;
* Sistemi za upravljanje z izvorno kodo: Git, Subversion;
...
* Administriracija wordpress strani:
  * (2003 - danes) Planinsko društvo vipava Spletišče vasi Slap,
  * (2008 - 2011) včasih sem Študentski dom Topniška in
  * ( - 2016) Spletišče vasi Slap
